(function (global, factory) {
    ...
    var rs__namespace = /*#__PURE__*/_interopNamespace(rs);
    ...
    ***************************************************************************** */
    ...
    var JwksValidationHandler = /** @class */ (function (_super) {
        ...
        JwksValidationHandler.prototype.validateSignature = function (params, retry) {
            ...
            var keyObj = rs__namespace.KEYUTIL.getKey(key);
            var validationOptions = {
                alg: this.allowedAlgorithms,
                gracePeriod: this.gracePeriodInSec,
            };
            var isValid = rs__namespace.KJUR.jws.JWS.verifyJWT(params.idToken, keyObj, validationOptions);
            if (isValid) {
        ...
        JwksValidationHandler.prototype.calcHash = function (valueToHash, algorithm) {
            var hashAlg = new rs__namespace.KJUR.crypto.MessageDigest({ alg: algorithm });
